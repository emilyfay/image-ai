...
class DCGAN(object):
    def __init__(self, sess, image_size=64, is_crop=False,
                 ...
                 checkpoint_dir=None, out_path =None, lam=0.1):
        """
    ...
    def train(self, config):
        ...
        g_optim_init = tf.train.AdamOptimizer(config.learning_rate, beta1=config.beta1, epsilon = 0.001) \
        ...
        for epoch in xrange(config.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                l = np.random.randint(int(64/6),int(64/3.5))
                l_end = 64
